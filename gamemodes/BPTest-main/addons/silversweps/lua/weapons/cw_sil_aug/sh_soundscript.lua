...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 32/30, sound = "CW_KK_INS2_M4A1_BOLTRELEASE"},
	},
	...
	base_reload = {
		{time = 22/30, sound = "CW_KK_INS2_M4A1_MAGRELEASE"},
		{time = 24/30, sound = "CW_KK_INS2_M4A1_MAGOUT"},
		{time = 76/30, sound = "CW_KK_INS2_M4A1_MAGIN"},
	},

	base_reloadempty = {
		{time = 16/30, sound = "CW_KK_INS2_M4A1_MAGRELEASE"},
		{time = 17/30, sound = "CW_KK_INS2_M4A1_MAGOUT"},
		{time = 65/30, sound = "CW_KK_INS2_M4A1_MAGIN"},
		{time = 86/30, sound = "CW_KK_INS2_M4A1_BOLTBACK"},
		{time = 98/30, sound = "CW_KK_INS2_M4A1_BOLTRELEASE"},
	},
