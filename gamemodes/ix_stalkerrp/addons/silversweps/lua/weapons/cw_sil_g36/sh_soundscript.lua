...
SWEP.Sounds = {
	base_ready = {
		...
		{time = 39/30, sound = "CW_KK_INS2_G36_BOLTBACK"},
		{time = 48/30, sound = "CW_KK_INS2_G36_BOLTRELEASE"},
	...
	base_reloadempty = {
		{time = 23/32.2, sound = "CW_KK_INS2_GALIL_MAGRELEASE"},
		{time = 32/32.2, sound = "CW_KK_INS2_GALIL_MAGOUT"},
		{time = 84/32.2, sound = "CW_KK_INS2_GALIL_MAGIN"},
		{time = 99/32.2, sound = "CW_KK_INS2_GALIL_RATTLE"},
		{time = 118/32.2, sound = "CW_KK_INS2_G36_BOLTBACK"},
		{time = 128/32.2, sound = "CW_KK_INS2_G36_BOLTRELEASE"},
	},
	...
	base_reload_drum = {
		...
		{time = 128/31.8, sound = "CW_KK_INS2_GALIL_DRUM_MAGHIT"},
	...
	base_reloadempty_drum = {
		...
		{time = 128/31.8, sound = "CW_KK_INS2_GALIL_DRUM_MAGHIT"},
		{time = 161/31.8, sound = "CW_KK_INS2_GALIL_RATTLE"},
		{time = 166/31.8, sound = "CW_KK_INS2_G36_BOLTBACK"},
		{time = 196/31.8, sound = "CW_KK_INS2_G36_BOLTRELEASE"},
	...
	deployed_reload_empty = {
		...
		{time = 121/30, sound = "CW_KK_INS2_G36_BOLTBACK"},
		{time = 130/30, sound = "CW_KK_INS2_G36_BOLTRELEASE"},
	},
	...
	deployed_reload_empty_drum = {
		...
		{time = 190/31.8, sound = "CW_KK_INS2_G36_BOLTBACK"},
		{time = 201/31.8, sound = "CW_KK_INS2_G36_BOLTRELEASE"},
		{time = 223/31.8, sound = "CW_KK_INS2_UNIVERSAL_LEANIN"},
	},
