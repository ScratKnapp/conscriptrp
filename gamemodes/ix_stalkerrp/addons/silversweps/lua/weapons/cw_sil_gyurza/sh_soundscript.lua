...
SWEP.Sounds = {
	...
	base_reload = {
		{time = 0/30, sound = "CW_KK_INS2_GYURZA_MAGRELEASE"},
		{time = 15/30, sound = "CW_KK_INS2_GYURZA_MAGOUT"},
		{time = 35/30, sound = "CW_KK_INS2_GYURZA_MAGIN"},
		{time = 58/30, sound = "CW_KK_INS2_GYURZA_MAGHIT"},
	},

	base_reload_extmag = {
		{time = 0/30, sound = "CW_KK_INS2_GYURZA_MAGRELEASE"},
		{time = 7/30, sound = "CW_KK_INS2_GYURZA_MAGOUT"},
		{time = 35/30, sound = "CW_KK_INS2_GYURZA_MAGIN"},
		{time = 58/30, sound = "CW_KK_INS2_GYURZA_MAGHIT"},
	},
	...
	base_reloadempty = {
		{time = 0/30, sound = "CW_KK_INS2_GYURZA_MAGRELEASE"},
		{time = 7/30, sound = "CW_KK_INS2_GYURZA_MAGOUT"},
		{time = 40/30, sound = "CW_KK_INS2_GYURZA_MAGHIT"},
		{time = 47/30, sound = "CW_KK_INS2_MAKAROV_BOLTRELEASE"},
	},
