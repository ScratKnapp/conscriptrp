local att = {}
att.name = "cw_sil_leupold_scope"
att.displayNameShort = "Leupold"
att.displayName = "Leupold Mark 4"
att.aimPos = {"CWSILLEUPOLDPos", "CWSILLEUPOLDAng"}
att.FOVModifier = 0
...
if CLIENT then
	...
	att.description = {
		[1] = {t = "Provides 24x magnification.", c = CustomizableWeaponry.textColors.POSITIVE},
