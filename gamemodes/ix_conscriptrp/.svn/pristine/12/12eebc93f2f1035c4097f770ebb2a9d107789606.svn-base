...
ENT.Type = "anim"
ENT.PrintName = "Admin Forcefield"
ENT.Category = "HL2 RP"
ENT.Spawnable = true
ENT.AdminOnly = true
...
if (SERVER) then
	...
	hook.Add("ShouldCollide", "ix_adminforcefields", function(a, b)
		local client
		local entity
