...
local background2 = Material("testsmiley.png")
local background3 = Material("testsmiley.png")
local background4 = Material("testsmiley.png")
local background5 = Material("testsmiley.png")
