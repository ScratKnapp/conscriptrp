...
if CLIENT then
	...
	function att:drawRenderTarget()
		...
		if not self.freeAimOn then
			...
			ang:RotateAroundAxis(ang:Right(), self.NO32AxisAlign.right)
			ang:RotateAroundAxis(ang:Up(), self.NO32AxisAlign.up)
			ang:RotateAroundAxis(ang:Forward(), self.NO32AxisAlign.forward)
		end
