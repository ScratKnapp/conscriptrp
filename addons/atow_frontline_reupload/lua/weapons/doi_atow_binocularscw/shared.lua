...
if CLIENT then
	...
	SWEP.PrintName = "Binoculars - British"
	SWEP.ViewModelMovementScale = .75
	SWEP.UseHands = false
	
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_binoculars_british")
	killicon.AddFont("doi_atow_cwbinoculars", "vgui/inventory/weapon_binoculars_british", Color(255, 80, 0, 0))
	
	SWEP.OverrideAimMouseSens = 1
	
	SWEP.DrawTraditionalWorldModel = false
	SWEP.WM = "models/khrcw2/doipack/w_gbbinoculars.mdl"
	...
	SWEP.AimOverlay = surface.GetTextureID("models/khrcw2/doipack/binoculars/binocs_overlay_british")
end
...
SWEP.ViewModel		= "models/khrcw2/doipack/gbbinoculars.mdl"
SWEP.WorldModel		= "models/khrcw2/doipack/w_gbbinoculars.mdl"
