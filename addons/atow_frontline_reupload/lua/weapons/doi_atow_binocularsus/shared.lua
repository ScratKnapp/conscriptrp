...
if CLIENT then
	...
	killicon.AddFont("doi_atow_usbinoculars", "vgui/inventory/weapon_binoculars_american", Color(255, 80, 0, 0))
	
	SWEP.OverrideAimMouseSens = 1
	
	SWEP.DrawTraditionalWorldModel = false
	SWEP.WM = "models/khrcw2/doipack/w_usbinoculars.mdl"
	...
	SWEP.AimOverlay = surface.GetTextureID("models/khrcw2/doipack/binoculars/binocs_overlay_american")
end
...
SWEP.ViewModel		= "models/khrcw2/doipack/usbinoculars.mdl"
SWEP.WorldModel		= "models/khrcw2/doipack/w_usbinoculars.mdl"
