...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/a_suppressor_pistol.mdl", bone = "A_Suppressor", pos = Vector(0, 1, 0), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), merge = false},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/w_sil_pistol.mdl", pos = Vector(-28.3, 0, 11.2), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = false},
	...
	SWEP.IronsightPos = Vector(-1.8521, 0, 0.6234)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_fort12.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_fort12.mdl"
