...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/silver/stalker/weapons/attachments/v_mk47_sights.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},

		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/a_suppressor_sec.mdl", pos = Vector(-5, 0, 0), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), attachment = "Muzzle"},
	...
	SWEP.IronsightPos = Vector(-2.4742, -2, 0.5828)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_mk47.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_mk47.mdl"
