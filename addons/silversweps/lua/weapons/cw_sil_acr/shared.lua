...
CustomizableWeaponry:registerAmmo("6.8SPC", "6.8 SPC", 6.8, 43)

if CLIENT then
	SWEP.DrawCrosshair = false
	SWEP.PrintName = "Busmaster ACR"
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_optic_iron"] = {model = "models/silver/stalker/weapons/attachments/a_acr_sights.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_iron"] = {model = "models/silver/stalker/weapons/attachments/w_acr_sights.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
	...
	SWEP.IronsightPos = Vector(-2.749, -2, 0.9535)
	SWEP.IronsightAng = Vector(0.1915, 0.0105, 0)

	SWEP.KKINS2KobraPos = Vector(-2.75, 0, 0.6936)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-2.7456, 0, 0.5236)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-2.7439, 0, 0.7597)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-2.7356, 1, 0.4252)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-2.6764, 0, 0.8519)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-2.7328, 1, 0.7475)
	SWEP.KKINS2MagnifierAng = Vector()

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.7439, 0, 0.7597)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_acr.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_acr.mdl"
...
SWEP.Primary.Ammo			= "6.8SPC"

SWEP.FireDelay = 60/700
SWEP.FireSound = "CW_SIL_ACR_FIRE"
SWEP.FireSoundSuppressed = "CW_SIL_ACR_FIRE_SUPPRESSED"
SWEP.Recoil = 1.1
