...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["std_mag"] = {model = "models/silver/stalker/weapons/attachments/a_saiga12_5.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cw_sil_saiga_10"] = {model = "models/silver/stalker/weapons/attachments/a_saiga12_10.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["cw_sil_saiga_20"] = {model = "models/silver/stalker/weapons/attachments/a_saiga12_20.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["std_mag"] = {model = "models/silver/stalker/weapons/attachments/w_saiga12_5.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["cw_sil_saiga_10"] = {model = "models/silver/stalker/weapons/attachments/w_saiga12_10.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["cw_sil_saiga_20"] = {model = "models/silver/stalker/weapons/attachments/w_saiga12_20.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
...
SWEP.Attachments = {
	...
	{header = "Magazine", offset = {-150, 500}, atts = {"cw_sil_saiga_10", "cw_sil_saiga_20"}},
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_saiga12.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_saiga12.mdl"
