...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-1.859, 0, 0.2868)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_tokarev_unique.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_tokarev_unique.mdl"
...
SWEP.FireDelay = 0.1
SWEP.FireSound = "CW_SIL_TT33_FIRE"
