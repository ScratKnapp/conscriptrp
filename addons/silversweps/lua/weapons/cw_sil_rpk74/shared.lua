...
SWEP.Attachments = {
	{header = "Sight", offset = {400, -450}, atts = {"cw_sil_okp7_optic", "cw_sil_ekp_optic", "cw_sil_pso1_scope"}},
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_rpk74.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_rpk74.mdl"
