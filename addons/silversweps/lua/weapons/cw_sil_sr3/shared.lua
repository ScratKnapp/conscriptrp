...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/a_suppressor_sec.mdl", pos = Vector(0, -1.5, 9.5), angle = Angle(90, 0, 0), size = Vector(0.75, 0.75, 0.75), bone = "A_Optic"},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_sec"] = {model = "models/weapons/upgrades/w_sil_sec1.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), attachment = "silencer"},
	...
	SWEP.IronsightPos = Vector(-2.6415, -2, 0.8808)
...
SWEP.Animations = {
	...
	base_reload_mm = "foregrip_reload",
	base_reload_empty_mm = "foregrip_reloadempty",
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_sr3.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_sr3.mdl"
...
SWEP.FireSound = "CW_SIL_SR3_FIRE"
SWEP.FireSoundSuppressed = "CW_SIL_SR3_FIRE_SUPPRESSED"
SWEP.Recoil = 0.95
