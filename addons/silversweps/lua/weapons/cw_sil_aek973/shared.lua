...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["cw_sil_ekp_optic"] = {model = "models/silver/stalker/weapons/attachments/a_ekp_new_optic.mdl", bone = "A_Optic", rLight = true, pos = Vector(0, 0.4, 0), angle = Angle(90, 90, 0), size = Vector(1.1, 1.1, 1.1), merge = false},
		["cw_sil_pk1_optic"] = {model = "models/silver/stalker/weapons/attachments/a_pk1_optic.mdl", bone = "A_Optic", rLight = true, pos = Vector(-0.05, 0.25, 0), angle = Angle(90, 90, 0), size = Vector(1.1, 1.1, 1.1), merge = false},
		["cw_sil_pka_optic"] = {model = "models/silver/stalker/weapons/attachments/a_pka_optic.mdl", bone = "A_Optic", rLight = true, pos = Vector(-0.05, 0.25, -0.25), angle = Angle(90, 90, 0), size = Vector(1.1, 1.1, 1.1), merge = false},
		...
		["cw_sil_ip78_scope"] = {model = "models/silver/stalker/weapons/attachments/a_scope_ip78.mdl", bone = "A_Optic", pos = Vector(0, -0.1, -2.75), angle = Angle(90, 90, 0 ), size = Vector(0.9, 0.9, 0.9), merge = false},
	}
	...
	SWEP.CWSILEKPPos = Vector(-2.3114, 3, -0.8725)
