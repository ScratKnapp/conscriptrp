...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_lam"] = {model = "models/weapons/upgrades/a_laser_m9.mdl", attachment = "Laser", pos = Vector(-0.9, 0.5, 0.1), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85)},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/a_flashlight_m9.mdl", attachment = "Laser", pos = Vector(-0.5, 0.5, 0.1), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85)},
		["kk_ins2_flashlight_legacy"] = {model = "models/weapons/upgrades/a_flashlight_m9.mdl",attachment = "Laser", pos = Vector(-0.6, 0.5, 0.1), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85)},
		["kk_ins2_m6x"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_m6x.mdl", attachment = "Laser", pos = Vector(-3.6, 0.5, 0.1), angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85)},
	...
	SWEP.IronsightPos = Vector(-2.4521, 0, 1.3434)
...
SWEP.ViewModel		= "models/weapons/browninghp/v_browninghp.mdl"
SWEP.WorldModel		= "models/weapons/browninghp/w_browninghp.mdl"
