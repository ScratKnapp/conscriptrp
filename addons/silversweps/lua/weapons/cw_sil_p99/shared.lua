...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/a_suppressor_pistol.mdl", bone = "A_Suppressor", pos = Vector(0, 1, -0.2), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), merge = false},

		["kk_ins2_lam"] = {model = "models/weapons/upgrades/a_laser_m9.mdl", bone = "A_Underbarrel", pos = Vector(0.4, 0, 0), angle = Angle(), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_flashlight"] = {model = "models/weapons/upgrades/a_flashlight_m9.mdl", bone = "A_Underbarrel", pos = Vector(0, 0, -0.2), angle = Angle(), size = Vector(0.8, 0.8, 0.8), merge = false},
	...
	SWEP.IronsightPos = Vector(-1.8521, 0, 0.5034)
	SWEP.IronsightAng = Vector(0.5, 0.07, 0)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_p99.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_p99.mdl"
