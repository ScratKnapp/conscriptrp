...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_magnifier"] = {model = "models/weapons/upgrades/a_optic_aimp2x.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},

		["kk_ins2_aimpoint"] = {model = "models/weapons/upgrades/a_optic_aimpoint.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_elcan"] = {model = "models/weapons/upgrades/a_optic_elcan_m.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false, retSizeMult = 0.85},
		["kk_ins2_eotech"] = {model = "models/weapons/upgrades/a_optic_eotech.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_kobra"] = {model = "models/weapons/upgrades/a_optic_kobra_l.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false, retSizeMult = 1.2},
		["kk_ins2_po4"] = {model = "models/weapons/upgrades/a_optic_po4x24.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_scope_mosin"] = {model = "models/weapons/upgrades/a_optic_mosin.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		
		["kk_ins2_scope_m40"] = {model = "models/weapons/upgrades/a_optic_m40.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["cw_sil_pilad_scope"] = {model = "models/silver/stalker/weapons/attachments/a_scope_pilad.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["cw_sil_leupold_scope"] = {model = "models/silver/stalker/weapons/attachments/a_scope_leupold.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},

		["kk_ins2_cstm_cmore"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_cmore.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(180, 0, 90), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_cstm_compm4s"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_compm4s.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_cstm_microt1"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_microt1.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_cstm_acog"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_acog_m.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false, retSizeMult = 0.85},
		["kk_ins2_cstm_barska"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_barska.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
		["kk_ins2_cstm_eotechxps"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_eotechxps.mdl", rLight = true, bone = "A_Optic", pos = Vector(0, 0.25, 0.5), angle = Angle(90, 90, 0), size = Vector(1, 1, 1), merge = false},
	}
	...
	SWEP.IronsightPos = Vector(-2.813, -2, 1.250)
	SWEP.IronsightAng = Vector(-0.2, 0.03, 0)

	SWEP.KKINS2KobraPos = Vector(-2.8164, -2, 0.1282)
	SWEP.KKINS2KobraAng = Vector(0,0.015,0)

	SWEP.KKINS2EoTechPos = Vector(-2.8154, -2, 0.2082)
	SWEP.KKINS2EoTechAng = Vector(0,0.015,0)

	SWEP.KKINS2AimpointPos = Vector(-2.8243, -2, 0.2082)
	SWEP.KKINS2AimpointAng = Vector(0,0.015,0)

	SWEP.KKINS2ElcanPos = Vector(-2.8165, -3.5, 0.0282)
	SWEP.KKINS2ElcanAng = Vector(0,0.015,0)

	SWEP.KKINS2PO4Pos = Vector(-2.7547, -3.5, 0.282)
	SWEP.KKINS2PO4Ang = Vector(0,0.015,0)

	SWEP.KKINS2ScopeMosinPos = Vector(-2.79, -2, .655)
	SWEP.KKINS2ScopeMosinAng = Vector(0,0,0)

	SWEP.KKINS2MagnifierPos = Vector(-2.815, -2.5, 0.1582)
	SWEP.KKINS2MagnifierAng = Vector(0,0.015,0)
	
	SWEP.KKINS2CSTMCMorePos = Vector(-2.8154, -2, 0.2282)
	SWEP.KKINS2CSTMCMoreAng = Vector(0,0.015,0)

	SWEP.KKINS2CSTMBarskaPos = Vector(-2.8154, -2, 0.2282)
	SWEP.KKINS2CSTMBarskaAng = Vector(0,0.015,0)

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.8154, -2, 0.2282)
	SWEP.KKINS2CSTMMicroT1Ang = Vector(0,0.015,0)

	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-2.8154, -2, 0.2282)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector(0,0.015,0)

	SWEP.KKINS2CSTMCompM4SPos = Vector(-2.8154, -2, 0.2282)
	SWEP.KKINS2CSTMCompM4SAng = Vector(0,0.015,0)

	SWEP.KKINS2CSTMACOGPos = Vector(-2.8154, -3, 0.0682)
	SWEP.KKINS2CSTMACOGAng = Vector(0,0.015,0)
	
	SWEP.KKINS2ScopeM40Pos = Vector(-2.8131, 0, 0.5989)
	SWEP.KKINS2ScopeM40Ang = Vector()	
	
	SWEP.CWSILPILADPos = Vector(-2.8131, 0, 0.4989)
	SWEP.CWSILPILADAng = Vector()	
	
	SWEP.CWSILLEUPOLDPos = Vector(-2.8131, 0, 0.3989)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_vpo215.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_vpo215.mdl"
...
SWEP.FireSound = "CW_SIL_VPO215_FIRE"
