...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["kk_ins2_aimpoint"] = {model = "models/weapons/upgrades/a_optic_aimpoint_m.mdl", bone = "A_Optic", pos = Vector(0, -0.1, 1.5), angle = Angle(90, 0, 90), size = Vector(1, 1, 1), merge = false, retSizeMult = 0.85},
		["kk_ins2_elcan"] = {model = "models/weapons/upgrades/a_optic_elcan_m.mdl", bone = "A_Optic", rLight = true, pos = Vector(0, -0.1, 1.5), angle = Angle(90, 0, 90), size = Vector(1, 1, 1), merge = false, retSizeMult = 0.85},
		["kk_ins2_eotech"] = {model = "models/weapons/upgrades/a_optic_eotech_m.mdl", bone = "A_Optic", pos = Vector(0, -0.1, 1.5), angle = Angle(90, 0, 90), size = Vector(1, 1, 1), merge = false, retSizeMult = 0.85},
		["kk_ins2_kobra"] = {model = "models/weapons/upgrades/a_optic_kobra.mdl", bone = "A_Optic", pos = Vector(0, -0.1, 1.5), angle = Angle(90, 0, 90), size = Vector(1, 1, 1), merge = false},
		...
		["kk_ins2_cstm_cmore"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_cmore_m.mdl", bone = "A_Optic", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 0.85},
		["kk_ins2_cstm_compm4s"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_compm4s_m.mdl", bone = "A_Optic", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 0.85},
		["kk_ins2_cstm_microt1"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_microt1_m.mdl", bone = "A_Optic", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 0.85},
		["kk_ins2_cstm_acog"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_acog_m.mdl", bone = "A_Optic", rLight = true, pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 0.85},
		["kk_ins2_cstm_barska"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_barska_m.mdl", bone = "A_Optic", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 0.85},
		["kk_ins2_cstm_eotechxps"] = {model = "models/weapons/attachments/v_cw_kk_ins2_cstm_eotechxps_m.mdl", bone = "A_Optic", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, retSizeMult = 0.85},
	}
	...
	SWEP.IronsightPos = Vector(-2.308, -2, 0.6207)
	SWEP.IronsightAng = Vector(0.3131, 0, 0)

	SWEP.KKINS2KobraPos = Vector(-2.3394, -2, -0.0439)
	SWEP.KKINS2KobraAng = Vector(0, -0.087, 0)

	SWEP.KKINS2EoTechPos = Vector(-2.3252, -2, -0.0142)
	SWEP.KKINS2EoTechAng = Vector(0, -0.087, 0)

	SWEP.KKINS2AimpointPos = Vector(-2.3357, -1, 0.0176)
	SWEP.KKINS2AimpointAng = Vector(0, -0.087, 0)

	SWEP.KKINS2ElcanPos = Vector(-2.3299, -1, -0.2836)
	SWEP.KKINS2ElcanAng = Vector(0, -0.087, 0)

	SWEP.KKINS2PO4Pos = Vector(-2.2805, -3, 0.0772)
	SWEP.KKINS2PO4Ang = Vector(0, -0.087, 0)

	SWEP.KKINS2MagnifierPos = Vector(-2.328, -2, -0.0111)
	SWEP.KKINS2MagnifierAng = Vector(0, -0.087, 0)

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-2.3299, -1, -0.0093)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_mp5sd.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_mp5sd.mdl"
...
SWEP.FireSound = "CW_KK_INS2_MP5A4_FIRE_SUPPRESSED"
