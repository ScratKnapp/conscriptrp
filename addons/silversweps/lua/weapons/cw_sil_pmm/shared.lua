...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/a_suppressor_pistol.mdl", bone = "A_Suppressor", pos = Vector(0, -0.1, -0.2), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), merge = false},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_suppressor_pistol"] = {model = "models/weapons/upgrades/w_sil_pistol.mdl", pos = Vector(-29.4, 0, 11), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), merge = false},
	...
	SWEP.IronsightPos = Vector(-1.9038, 0, 0.65)
...
SWEP.ViewModel		= "models/silver/stalker/weapons/v_pmm.mdl"
SWEP.WorldModel		= "models/silver/stalker/weapons/w_pmm.mdl"
