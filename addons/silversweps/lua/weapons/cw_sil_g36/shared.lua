...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		["kk_ins2_galil"] = {model = "models/weapons/customupgrades/a_standard_galil.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		["kk_ins2_optic_rail"] = {model = "models/weapons/customupgrades/a_mount_galil.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		...
		["kk_ins2_mag_galil_35"] = {model = "models/weapons/customupgrades/a_magazine_galil_35.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		...
		["kk_ins2_bipod"] = {model = "models/weapons/customupgrades/a_bipod_galil.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.AttachmentModelsWM = {
		["kk_ins2_optic_rail"] = {model = "models/weapons/customupgrades/w_mount_galil.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
		["kk_ins2_mag_galil_35"] = {model = "models/weapons/customupgrades/w_magazine_galil_35.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true, active = true},
		...
		["kk_ins2_bipod"] = {model = "models/weapons/customupgrades/w_bipod_galil.mdl", pos = Vector(), angle = Angle(), size = Vector(1, 1, 1), merge = true},
	...
	SWEP.IronsightPos = Vector(-3.0659, -2, 0.26)
	SWEP.IronsightAng = Vector(0, 0, 0)

	SWEP.KKINS2KobraPos = Vector(-3.0659, -2, -0.757)
	SWEP.KKINS2KobraAng = Vector()

	SWEP.KKINS2EoTechPos = Vector(-3.0659, -2, -0.607)
	SWEP.KKINS2EoTechAng = Vector()

	SWEP.KKINS2AimpointPos = Vector(-3.0659, -2, -0.607)
	SWEP.KKINS2AimpointAng = Vector()

	SWEP.KKINS2ElcanPos = Vector(-3.0601, -5, -0.73)
	SWEP.KKINS2ElcanAng = Vector()

	SWEP.KKINS2PO4Pos = Vector(-3.011, -5.5, -0.377)
	SWEP.KKINS2PO4Ang = Vector()

	SWEP.KKINS2MagnifierPos = Vector(-3.0592, -5, -0.635)
	SWEP.KKINS2MagnifierAng = Vector()
	
	SWEP.KKINS2CSTMCMorePos = Vector(-3.0659, -2, -0.607)
	SWEP.KKINS2CSTMCMoreAng = Vector()

	SWEP.KKINS2CSTMBarskaPos = Vector(-3.0659, -2, -0.607)
	SWEP.KKINS2CSTMBarskaAng = Vector()

	SWEP.KKINS2CSTMMicroT1Pos = Vector(-3.0659, -2, -0.607)
	SWEP.KKINS2CSTMMicroT1Ang = Vector()
	
	SWEP.KKINS2CSTMEoTechXPSPos = Vector(-3.0659, -2, -0.607)
	SWEP.KKINS2CSTMEoTechXPSAng = Vector()

	SWEP.KKINS2CSTMCompM4SPos = Vector(-3.0659, -2, -0.607)
	SWEP.KKINS2CSTMCompM4SAng = Vector()
	
	SWEP.KKINS2CSTMACOGPos = Vector(-3.0621, -5, -0.73)
...
SWEP.ViewModel		= "models/weapons/g36/v_g36.mdl"
SWEP.WorldModel		= "models/weapons/g36/w_g36.mdl"

SWEP.WMPos = Vector(3.919, 0.964, -1.055)
...
SWEP.FireSound = "CW_KK_INS2_G36_FIRE"
SWEP.FireSoundSuppressed = "CW_KK_INS2_G36_FIRE_SUPPRESSED"
