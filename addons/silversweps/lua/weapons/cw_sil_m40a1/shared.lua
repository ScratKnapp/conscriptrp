...
if CLIENT then
	...
	SWEP.CWSILPILADPos = Vector(-2.8131, 1, 0.5989)
	SWEP.CWSILPILADAng = Vector()	
	
	SWEP.CWSILLEUPOLDPos = Vector(-2.8131, 1, 0.4989)
...
SWEP.Attachments = {
	{header = "Sight", offset = {500, -450}, atts = {"cw_sil_pilad_scope", "cw_sil_leupold_scope", "kk_ins2_kobra", "kk_ins2_eotech", "kk_ins2_aimpoint", "kk_ins2_elcan", "kk_ins2_po4", "kk_ins2_scope_m40", "kk_ins2_cstm_cmore", "kk_ins2_cstm_barska", "kk_ins2_cstm_microt1", "kk_ins2_cstm_eotechxps", "kk_ins2_cstm_compm4s", "kk_ins2_cstm_acog"}},
