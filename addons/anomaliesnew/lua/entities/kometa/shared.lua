...
ENT.Type = "anim"  
ENT.PrintName		= "Kometa[Moving]" 
ENT.SetName		= "Kometa[Moving]" 
ENT.Editable = false
ENT.Spawnable = true
ENT.AdminOnly = false
...
if CLIENT then
	function ENT:Initialize()
		self.particle = CreateParticleSystem( self, "kometa", PATTACH_ABSORIGIN_FOLLOW, 0, Vector(0,0,0) )
		self:EmitSound("kometa_idle")
	end
	function ENT:Think()
