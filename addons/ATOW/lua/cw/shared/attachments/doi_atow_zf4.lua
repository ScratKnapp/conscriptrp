...
if CLIENT then
	...
	function att:drawRenderTarget()
		...
		if not self.freeAimOn then
			...
			ang:RotateAroundAxis(ang:Right(), self.M823AxisAlign.right)
			ang:RotateAroundAxis(ang:Up(), self.M823AxisAlign.up)
			ang:RotateAroundAxis(ang:Forward(), self.M823AxisAlign.forward)
		end
